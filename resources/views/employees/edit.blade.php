                ...
                <div class="card-body">
                    <form action="{{url('employees/'.$employee->id.'/edit')}}" method='POST'>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class='form-control' name='employee_tel' value={{$employee->employee_tel}}>
                            @error('employee_tel')
                            <span class='text-danger'>{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class='form-control' name='employee_department' value={{$employee->employee_department}}>
